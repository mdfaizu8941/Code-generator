  ...
  return (
    <Layout>
      <div className="h-full flex flex-col">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Favorite Snippets</h1>
          <p className="text-gray-500 dark:text-gray-500">Your most used and loved generated code.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200 dark:text-gray-700 mb-2">No favorites yet</h3>
            ...
            <AnimatePresence>
              {snippets.map((snippet, index) => (
                <motion.div 
                  ...
                  key={snippet._id}
                  className="bg-white dark:bg-gray-900 dark:bg-white rounded-2xl border border-red-100 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-red-300 cursor-pointer group transition-all p-5 flex flex-col h-56"
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <button 
                      ...
                      className="p-2 -mr-2 -mt-2 rounded-full transition-colors text-red-500 hover:bg-red-50 dark:bg-red-900/20"
                    >
